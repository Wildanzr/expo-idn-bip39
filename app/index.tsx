...
export default function Screen() {
  ...
  return (
    ...
    >
      ...
      <Button onPress={async () => await generateNewWallet()} variant="primary">
      ...
      {wallet ? (
        ...
        <>
          ...
          <Text color="tertiary" variant="subhead" className="pb-2 text-center">
            Dibuat untuk mendukung adopsi crypto dan blockchain di Indonesia
          ...
          <Text color="tertiary" variant="subhead" className="pb-4 text-center">
            ...
            pembuat BIP39 Bahasa Indonesia.
          </Text>
        </>
      )}
    </View>
